...
- QuadDecoder; Acquired via RIT provided; Library cannot be included due to RIT licensing

---== Equipment used for my project is listed below for scope of the project and compatibility test ==---
- Teensy 4.0 Microcontroller
- x2 Digi International XBee's
- Motor Shield
- Ultrasonic Sensor
